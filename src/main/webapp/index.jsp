      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="zcash_landingPage.jsp"> <i class="icon-grid"></i>Transactions    </a></li>
            ...
            <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> 
         	...
         	<% if(session.getAttribute("metro_token") !=null ) {%>
                <li><a href="MetroController?page=TrxnsList">Metro OpenBanking</a></li>
                <% }%>
                	<% if(session.getAttribute("Liquid_token") !=null ) {%>
                <li><a href="#">Liquid Cash</a></li>
                 <% }%>
                 <% if(session.getAttribute("Flash_token") !=null ) {%>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.jsp" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><span>Z Cash </span><strong class="text-primary">Dashboard</strong></div></a></div>
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item dropdown"> <a id="messages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="fa fa-envelope"></i><span class="badge badge-info">10</span></a>
                  <ul aria-labelledby="notifications" class="dropdown-menu">
                    ...
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                        ...
                        <div class="msg-body">
                          <h3 class="h5">KASADMIN</h3><span>sent a direct message</span><small>3 days ago at 7:58 pm - 10.06.2014</small>
                        </div></a></li>
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                ...
                <!-- Log out-->
                <li class="nav-item"><a href="MetroController?page=logout" class="nav-link logout"> <span class="d-none d-sm-inline-block">Logout</span><i class="fa fa-sign-out"></i></a></li>
              </ul>
            </div>
          </div>
        </nav>
          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Cash Out Trxns</strong><span>Last 7 days</span>
...
<!--             <div class="col-xl-2 col-md-4 col-6">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Cash In Trxns </strong><span>Last 7 days</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">New Invoices</strong><span>Last 7 days</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Bill Payments</strong><span>Last 7 days</span>
               ...
               <!--  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p> -->
                <ul class="check-lists list-unstyled">
                  <li class="d-flex align-items-center"> 
                    ...
                    <label for="list-1">Pay electricity bill</label>
                  </li>
                  <li class="d-flex align-items-center"> 
                    <input type="checkbox" id="list-2" name="list-2" class="form-control-custom">
                    <label for="list-2">Pay water bill</label>
                  </li>
    <!--               <li class="d-flex align-items-center"> 
            ...
            <div class="col-lg-3 col-md-6">
              <div class="card project-progress">
                <h2 class="display h4">This month's Monetary Allocation</h2>
               <!--  <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p> -->
                <div class="pie-chart">
            ...
            <div class="col-lg-6 col-md-12 flex-lg-last flex-md-first align-self-baseline">
              <div class="card sales-report">
                <h2 class="display h4">Income Fluctuation</h2>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="img/avatar-2.jpg" alt="person" class="img-fluid rounded-circle"></a>
                            <div class="content"><strong>KASADMIN</strong><small>Posted a new blog </small>
                              <div class="full-date"><small>Today 5:60 pm - 12.06.2014</small></div>
