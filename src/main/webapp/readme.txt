...
Changing to another colour variant, is just a matter of replacing css/style.default.css with css/style.pink.css in index.jsp.
...
- removed .wrapper in index.jsp and replaced it by .card
- changed a syntax of the widgets in index.jsp, now much less dependent on section 
